...
public class CuentaInversorCNV {
    ...
    public static CuentaInversorCNV getValue(Persona persona){
        ...
        cuentaInversorCNV
                .setGrupoCuentas(
                        new GrupoCuenta(
                                LocalDate.now().toString(), //Fecha de desactivación del grupo de cuentas. Recomiendan fecha del momento
                                "Allow"
                        )
                )
                ...
                .setPaisEmision("ARGENTINA")//Todo: existe algun servicio para esto?
                .setFechaCaducidad(LocalDate.now().toString()) //Fecha de desactivación del grupo de cuentas. Recomiendan fecha del momento
                .setCoPropietarios(
                        Objeto.listOf(
                                new CoPropietario(
                                        new Propietario(
                ...
                .setIdentificadorOperador("139") //operatoridentifier Numero de depositante 139 - 1270
                .setTipoOperador("PCODE") //solo permite este valor
                .setFechaRegistro(LocalDate.now().toString())
                .setValoresCuentas(
                        Objeto.listOf(
                                new ValoresCuenta(
                                        "",//No obligatorio
                                        ...
                                        false, //No requerido, por defecto false
                                        new Emisor(
                                                "",//No requerido País de emisión.
//                                                LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd")), // requerido - Fecha de vencimiento.
                                                LocalDate.now().toString(), // requerido - Fecha de vencimiento.
                                                "", //No requerido - Identificador único.
                                                "ARGENTINA", //PaisEntidodadEmisora
                                                LocalDate.now().toString(), //fecha de registro
