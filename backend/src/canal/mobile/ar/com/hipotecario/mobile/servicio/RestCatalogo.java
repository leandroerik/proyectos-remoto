...
public class RestCatalogo {
	...
	/* ========== SERVICIOS ========== */
	public static ApiResponseMB paises(ContextoMB contexto) {
		ApiRequestMB request = ApiMB.request("Paises", "catalogo", "GET", "/v1/paises", contexto);
		request.cacheSesion = true;
		return ApiMB.response(request);
	}

	public static ApiResponseMB provincias(ContextoMB contexto) {
		ApiRequestMB request = ApiMB.request("Provincias", "catalogo", "GET", "/v1/paises/{idPais}/provincias", contexto);
		request.path("idPais", "80");
		request.cacheSesion = true;
		return ApiMB.response(request, "80");
	}

	public static ApiResponseMB localidades(ContextoMB contexto, String idProvincia) {
		ApiRequestMB request = ApiMB.request("Localidades", "catalogo", "GET", "/v1/paises/{idPais}/provincias/{idProvincia}/ciudades", contexto);
		request.path("idPais", "80");
		request.path("idProvincia", idProvincia);
		request.cacheSesion = true;
		return ApiMB.response(request, "80", idProvincia);
	}

	public static ApiResponseMB estadosCiviles(ContextoMB contexto) {
		ApiRequestMB request = ApiMB.request("EstadosCiviles", "catalogo", "GET", "/v1/estadoCiviles", contexto);
		request.cacheSesion = true;
		return ApiMB.response(request);
	}

	public static ApiResponseMB situacionesLaborales(ContextoMB contexto) {
		ApiRequestMB request = ApiMB.request("SituacionLaboral", "ventas_windows", "GET", "/parametria/SituacionLaboral", contexto);
		request.cacheSesion = true;
		return ApiMB.response(request);
	}

	public static ApiResponseMB nivelesEstudio(ContextoMB contexto) {
		ApiRequestMB request = ApiMB.request("nivelesEstudios", "ventas_windows", "GET", "/parametria/NivelEstudios", contexto);
		request.cacheSesion = true;
		return ApiMB.response(request);
	}

	public static ApiResponseMB sucursales(ContextoMB contexto) {
		ApiRequestMB request = ApiMB.request("sucursales", "catalogo", "GET", "/v1/sucursales", contexto);
		request.query("codTipoSucursal", "1");
		request.cacheSesion = true;
		return ApiMB.response(request);
	}

	public static ApiResponseMB sucursalesV2(ContextoMB contexto, String idSucursal) {
		ApiRequestMB request = ApiMB.request("sucursales", "catalogo", "GET", "/v2/sucursales/{id}", contexto);
		request.path("id", idSucursal);
		request.cacheSesion = true;
		return ApiMB.response(request);
	}

	public static ApiResponseMB bancos(ContextoMB contexto) {
		ApiRequestMB request = ApiMB.request("bancos", "catalogo", "GET", "/v1/codigosBancos", contexto);
		request.query("Codigo", null);
		request.cacheSesion = true;
		return ApiMB.response(request);
	}

	public static ApiResponseMB calendarioFechaActual(ContextoMB contexto) {
		...
		ApiRequestMB request = ApiMB.request("CatalogoCalendario", "catalogo", "GET", "/v1/calendario/{fecha}", contexto);
	...
	public static ApiResponseMB calendarioFecha(ContextoMB contexto, String fecha) {
		ApiRequestMB request = ApiMB.request("CatalogoCalendario", "catalogo", "GET", "/v1/calendario/{fecha}", contexto);
		request.path("fecha", fecha);
		request.cacheSesion = true;
	...
	// Migrado el 19/9/22
	public static ApiResponseMB consultaRubrosDebitosAutomaticos(ContextoMB contexto, Integer paginaActual) {
		ApiRequestMB request = ApiMB.request("CatalogoRubrosDebitosAutomaticos", "catalogo", "GET", "/v1/consulta/RUBROS", contexto);
	...
	public static ApiResponseMB consultaEmpresasDebitosAutomaticos(ContextoMB contexto, String codigoRubro, Integer paginaActual) {
		ApiRequestMB request = ApiMB.request("CatalogoEmpresasDebitosAutomaticos", "catalogo", "GET", "/v1/consulta/EMPRESAS", contexto);
		request.query("cantidadRegistros", "30");
		request.query("codigoRubro", codigoRubro);
		request.query("numeroPagina", paginaActual.toString());
		request.cacheSesion = true;

		return ApiMB.response(request, contexto.idCobis(), codigoRubro, paginaActual.toString());
	}

	public static ApiResponseMB consultaServiciosDebitosAutomaticos(ContextoMB contexto, String codigoRubro, String cuitEmpresa, Integer paginaActual) {
		ApiRequestMB request = ApiMB.request("CatalogoServiciosDebitosAutomaticos", "catalogo", "GET", "/v1/consulta/SERVICIOS", contexto);
	...
	/* ========== UTIL ========== */
	public static Map<Integer, String> mapaPaises(ContextoMB contexto) {
		Map<Integer, String> mapa = new TreeMap<>();
		ApiResponseMB response = paises(contexto);
	...
	public static Map<Integer, String> mapaNacionalidades(ContextoMB contexto) {
		Map<Integer, String> mapa = new TreeMap<>();
		ApiResponseMB response = paises(contexto);
		if (!response.hayError()) {
			for (Objeto item : response.objetos()) {
	...
	public static Map<Integer, String> mapaProvincias(ContextoMB contexto) {
		Map<Integer, String> mapa = new TreeMap<>();
		ApiResponseMB response = provincias(contexto);
		if (!response.hayError()) {
			for (Objeto item : response.objetos()) {
	...
	public static String nombrePais(ContextoMB contexto, Integer idPais) {
		String nombrePais = mapaPaises(contexto).get(idPais);
		return nombrePais != null ? nombrePais : "";
	}

	public static String nombreNacionalidad(ContextoMB contexto, Integer idPais) {
		String nombreNacionalidad = mapaNacionalidades(contexto).get(idPais);
		return nombreNacionalidad != null ? nombreNacionalidad : "";
	}

	public static String nombreProvincia(ContextoMB contexto, Integer idProvincia) {
	...
	public static Map<Integer, String> mapaLocalidades(ContextoMB contexto, Integer idProvincia) {
		Map<Integer, String> mapa = new LinkedHashMap<>();
		if (idProvincia != null) {
			ApiResponseMB response = localidades(contexto, idProvincia.toString());
			if (!response.hayError()) {
	...
	public static String nombreLocalidad(ContextoMB contexto, Integer idProvincia, Integer idLocalidad) {
		String nombreLocalidad = mapaLocalidades(contexto, idProvincia).get(idLocalidad);
		return nombreLocalidad != null ? nombreLocalidad : "";
	}

	public static Map<String, String> mapaEstadosCiviles(ContextoMB contexto) {
		Map<String, String> mapa = new TreeMap<>();
		ApiResponseMB response = estadosCiviles(contexto);
		if (!response.hayError()) {
			for (Objeto item : response.objetos()) {
				mapa.put(item.string("id"), item.string("descripcion"));
			}
		}
		return mapa;
	}

	public static String nombreEstadoCivil(ContextoMB contexto, String idEstadoCivil) {
		String nombreEstadoCivil = mapaEstadosCiviles(contexto).get(idEstadoCivil);
		return nombreEstadoCivil != null ? nombreEstadoCivil : "";
	}

	public static Map<Integer, String> mapaSituacionesLaborales(ContextoMB contexto) {
		Map<Integer, String> mapa = new TreeMap<>();
		ApiResponseMB response = situacionesLaborales(contexto);
		if (!response.hayError()) {
			response.ordenar("Descripcion");
			for (Objeto item : response.objetos()) {
				mapa.put(item.integer("Id"), item.string("Descripcion"));
	...
	public static String nombreSituacionLaboral(ContextoMB contexto, Integer idSituacionLaboral) {
		String nombreSituacionLaboral = mapaSituacionesLaborales(contexto).get(idSituacionLaboral);
		return nombreSituacionLaboral != null ? nombreSituacionLaboral : "";
	}

	public static Map<Integer, String> mapaNivelesEstudios(ContextoMB contexto) {
		Map<Integer, String> mapa = new TreeMap<>();
		ApiResponseMB response = nivelesEstudio(contexto);
		if (!response.hayError()) {
			response.ordenar("descripcion");
			for (Objeto item : response.objetos()) {
				mapa.put(item.integer("Id"), item.string("Descripcion"));
	...
	public static String nombreNivelEstudio(ContextoMB contexto, Integer idNivelEstudio) {
		String nombreNivelEstudio = mapaNivelesEstudios(contexto).get(idNivelEstudio);
		return nombreNivelEstudio != null ? nombreNivelEstudio : "";
	}
	...
	public static SqlResponseMB paquetesBeneficios(ContextoMB contexto, String codigoPaquete) {
		SqlRequestMB sqlRequest = SqlMB.request("SelectPaquetesBeneficios", "hbs");
	...
	public static ApiResponseMB sucursalesPorProvincia(ContextoMB contexto, String idProvincia) {
		ApiRequestMB request = ApiMB.request("sucursales", "catalogo", "GET", "/v1/sucursales", contexto);
		request.query("codTipoSucursal", "1");
		if (!idProvincia.equals("")) {
			request.query("codProvincia", idProvincia);
		}
		request.cacheSesion = false;
		return ApiMB.response(request);
	}

	public static ApiResponseMB sucursalesPorTipoTurno(ContextoMB contexto, String idProvincia, String idTurno) {
		ApiRequestMB request = ApiMB.request("sucursalesPorTipoTurno", "catalogo", "GET", "/v1/sucursalesPorTipoTurno", contexto);
		request.query("codTipoSucursal", "1");
		request.query("codProvincia", idProvincia);
		request.query("codTipoTurno", idTurno);
		request.cacheSesion = false;
		return ApiMB.response(request);
	}

	public static ApiResponseMB motivos(ContextoMB contexto) {
		ApiRequestMB request = ApiMB.request("V1CobisReposicionGet", "catalogo", "GET", "/v1/cobis/reposicion", contexto);
		request.cacheSesion = false;
		return ApiMB.response(request);
	}

	public static ApiResponseMB formaPagoTC(ContextoMB contexto) {
		ApiRequestMB request = ApiMB.request("FormaPago", "catalogo", "GET", "/v1/formapago", contexto);
		request.query("marca", "2");
		request.cacheSesion = false;
		return ApiMB.response(request);
	}

	public static Map<Integer, String> mapaProvinciasPorCodigoPostal(ContextoMB contexto, String codigoPostal) {
		Map<Integer, String> mapa = new TreeMap<>();
		ApiResponseMB response = consultaCodigosPostales(contexto, codigoPostal);
		if (!response.hayError()) {
			for (Objeto item : response.objetos()) {
	...
	public static ApiResponseMB consultaCodigosPostales(ContextoMB contexto, String codigoPostal) {
		ApiRequestMB request = ApiMB.request("CatalogoCodigosPostales", "catalogo", "GET", "/v1/cp", contexto);
	...
	public static Map<Integer, String> mapaLocalidadesPorCodigoPostal(ContextoMB contexto, Integer idProvincia, String codigoPostal) {
		Map<Integer, String> mapa = new LinkedHashMap<>();
		if (idProvincia != null) {
			ApiResponseMB response = consultaCodigosPostales(contexto, codigoPostal);
			if (!response.hayError()) {
	...
	public static Map<String, Object> categoriaMonotributo(ContextoMB contexto) {
...
//		return sqlResponse;
	...
	public static Map<String, Object> categoriaMonotributoXMonto(ContextoMB contexto) {
//		SqlRequest sqlRequest = Sql.request("SelectCategoriaMonotributo", "CampaniasWF");
//		sqlRequest.sql = "SELECT * FROM [CampaniasWF].[dbo].[CategoriaMonotributoIngresos]";
//		SqlResponse sqlResponse = Sql.response(sqlRequest);
//		return sqlResponse;
