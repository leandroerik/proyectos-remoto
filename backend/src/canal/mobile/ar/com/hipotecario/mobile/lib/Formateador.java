...
public abstract class Formateador {
	...
	public static String importeUs(BigDecimal valor) {
		String numero = "";
		if (valor != null) {
			DecimalFormatSymbols decimalFormatSymbols = new DecimalFormatSymbols();
			decimalFormatSymbols.setDecimalSeparator('.');
	...
	public static String importePeso(BigDecimal valor) {
		return "$ " + importe(valor);
	}

	public static String importeUsPeso(BigDecimal valor) {
		return "$ " + importeUs(valor);
	}
