...
public class DocumentacionService {
	...
	public static List<Objeto> documentacionXSolicitud(ContextoMB contexto, String idSolicitud) {
		List<Objeto> documentos = new ArrayList<Objeto>();

		ApiRequestMB request = ApiMB.request("DocumentacionRequeridaBPM", "ventas_windows", "GET", "/solicitudes/{numeroSolicitud}/documentacion", contexto);
	...
	public static Objeto docRequeridoXCanalAmarillo(ContextoMB contexto, String idSolicitud) {
