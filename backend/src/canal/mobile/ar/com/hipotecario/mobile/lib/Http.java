...
public abstract class Http {
	...
	public static OkHttpClient okHttpClient() {
		...
		Integer ReadTimeOut = ConfigMB.integer("read_time_out", 120);
	...
	public static OkHttpClient okHttpClientProxy() {
		if (ConfigMB.string("proxy", null) == null) {
			return null;
		}
		...
		String urlProxy = ConfigMB.string("proxy").split(" ")[0];
		String puertoProxy = ConfigMB.string("proxy").split(" ")[1];
		String usuarioProxy = ConfigMB.string("proxy").split(" ")[2];
		String claveProxy = ConfigMB.string("proxy").split(" ")[3];
