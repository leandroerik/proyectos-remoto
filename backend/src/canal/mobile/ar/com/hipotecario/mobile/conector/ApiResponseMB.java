...
public class ApiResponseMB extends Objeto {

	private static Logger log = LoggerFactory.getLogger(ApiResponseMB.class);
	...
	/* ========== CONSTRUCTORES ========== */
	public ApiResponseMB() {
		this.codigo = 200;
	}

	public ApiResponseMB(ApiRequestMB request, Integer codigo, String json) {
		this.codigo = codigo;
		this.json = json;
		try {
	...
	/* ========== LOG ========== */
	public String log(ApiRequestMB request) {
		return log(request, null);
	}

	public String log(ApiRequestMB request, String origen) {
	...
	public String rawLog(ApiRequestMB request, Boolean encriptar) {
		StringBuilder log = new StringBuilder();
