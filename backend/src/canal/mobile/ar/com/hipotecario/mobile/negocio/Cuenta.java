...
public class Cuenta {
	...
	/* ========== CONSTRUCTOR ========== */
	public Cuenta(ContextoMB contexto, Objeto cuenta) {
	...
	public String tipoLargo() {
		String descripcion = "";
		descripcion = "AHO".equals(consolidada.string("tipoProducto")) ? "C.Ahorro" : descripcion;
		descripcion = "CTE".equals(consolidada.string("tipoProducto")) ? "Cta.Cte." : descripcion;
		descripcion = "ADE".equals(consolidada.string("tipoProducto")) ? "Adelanto" : descripcion;
		return descripcion;
	}

	public String tipoMediano() {
		String descripcion = "";
		descripcion = "AHO".equals(consolidada.string("tipoProducto")) ? "C.Ahorro" : descripcion;
		descripcion = "CTE".equals(consolidada.string("tipoProducto")) ? "Cta.Cte." : descripcion;
		descripcion = "ADE".equals(consolidada.string("tipoProducto")) ? "Adelanto" : descripcion;
	...
	public String comentario() {
		SqlResponseMB response = CuentasService.selectComentarioCuenta(contexto);
	...
	public String cbu() {
		ApiResponseMB response = CuentasService.cuentaBH(contexto, numero());
	...
	public String alias() {
		ApiResponseMB response = CuentasService.cuentaCoelsa(contexto, cbu());
	...
	public String usoFirma() {
		...
		ApiResponseMB response = CuentasService.cajaAhorroBH(contexto, numero());
	...
	public Objeto detalle() {
		ApiRequestMB request = ApiMB.request("DetalleCuenta", "cuentas", "GET", esCajaAhorro() ? "/v1/cajasahorros/{idcuenta}" : "/v1/cuentascorrientes/{idcuenta}", contexto);
