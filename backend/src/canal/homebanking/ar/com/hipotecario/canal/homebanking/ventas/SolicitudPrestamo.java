...
public class SolicitudPrestamo {
	...
	public Boolean esProcrearRefaccion() {
		Set<String> subProductosProcrearRefaccion = ConfigHB.esDesarrollo() ? Objeto.setOf("41", "42", "38") : Objeto.setOf("28", "29", "25");
	...
	public Boolean esPrestamoComplementario() {
		String subProductoPrestamoComplementario = ConfigHB.esDesarrollo() ? "43" : "30";
