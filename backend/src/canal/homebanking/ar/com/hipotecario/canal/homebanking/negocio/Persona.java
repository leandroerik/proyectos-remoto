...
public class Persona {
	...
	/* ========== CONSTRUCTOR ========== */
	public Persona(ContextoHB contexto, Objeto persona) {
	...
	public String nombreEscapado() {
		String caracteresValidos = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZñÑáéíóúÁÉÍÓÚ ";
		String nombre = "";
		String nombreOriginal = nombres();
		for (int i = 0; i < nombreOriginal.length(); ++i) {
			Character letra = nombreOriginal.charAt(i);
			if (caracteresValidos.contains(letra.toString())) {
				nombre += letra;
			}
		}
		return nombre;
	...
	public String apellidosEscapado() {
		String caracteresValidos = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZñÑáéíóúÁÉÍÓÚ ";
		String apellido = "";
		String apellidoOriginal = apellidos();
		for (int i = 0; i < apellidoOriginal.length(); ++i) {
			Character letra = apellidoOriginal.charAt(i);
			if (caracteresValidos.contains(letra.toString())) {
				apellido += letra;
			}
		}
