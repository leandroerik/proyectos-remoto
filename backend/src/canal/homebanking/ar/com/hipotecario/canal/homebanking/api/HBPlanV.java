...
public class HBPlanV {

	public static Respuesta obtenerInformacionFinanciamiento(ContextoHB contexto) {
		...
		ApiResponse response = TarjetaCreditoService.obtenerInformacionFinanciamiento(contexto, 
	...
	public static Respuesta simularFinanciamiento(ContextoHB contexto) {
		String idTarjetaCredito = contexto.parametros.string("idTarjetaCredito", null);
		String tipoDocumento = contexto.parametros.string("tipoDocumento", null);
		String genero = contexto.parametros.string("genero", null);
		...
		ApiResponse response = TarjetaCreditoService.simularFinanciamiento(contexto,cliente,tarjeta,
	...
	public static Respuesta confirmarFinanciamiento(ContextoHB contexto) {
		String idTarjetaCredito = contexto.parametros.string("idTarjetaCredito", null);
		String tipoDocumento = contexto.parametros.string("tipoDocumento", null);
		String genero = contexto.parametros.string("genero", null);
		String cuotas = contexto.parametros.string("cuotas", null);
		...
		ApiResponse response = TarjetaCreditoService.confirmarFinanciamiento(contexto,cliente,tarjeta,
	    		cuotas,moneda,monto,tipoResumen);
	...
	public static Respuesta obtenerFinanciamientosAprobados(ContextoHB contexto) {
		...
		ApiResponse response = TarjetaCreditoService.obtenerFinanciamientosAprobados(contexto,
				nroCuenta, tipo);
