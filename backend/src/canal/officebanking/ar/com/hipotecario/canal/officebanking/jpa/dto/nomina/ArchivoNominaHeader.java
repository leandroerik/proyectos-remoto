...
public class ArchivoNominaHeader extends OBRegistroImportado {
	...
	public static ArchivoNominaHeader readNominaHeaderFromFile(String contenidoArchivo) {
		ArchivoNominaHeader header = new ArchivoNominaHeader();
