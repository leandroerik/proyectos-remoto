...
@Entity
@Table(schema = "dbo", name = "OB_Historial_Pago_De_Haberes")
public class HistorialPagoDeHaberesOB {
    @Id
    ...
    @ManyToOne()
    public PagoDeHaberesOB pagoDeHaberes;
    ...
    public EstadoPagosHaberesOB estadoInicial;

    @ManyToOne()
    @JoinColumn(name = "id_est_final", nullable = false)
    public EstadoPagosHaberesOB estadoFinal;
