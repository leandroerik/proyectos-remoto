...
@Entity
@Table(schema = "dbo", name = "OB_Historial_Echeq")
public class HistorialEcheqOB {
    @Id
    ...
    public EstadoEcheqOB estadoInicial;

    @ManyToOne()
    @JoinColumn(name = "id_est_final", nullable = false)
    public EstadoEcheqOB estadoFinal;
