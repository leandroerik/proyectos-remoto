...
public class AnularCesionEcheqOB extends ApiObjetos<AnularCesionEcheqOB.result> {
    ...
    public static AnularCesionEcheqOB post(ContextoOB contexto, String idCheque, String cedenteDocumento,String cesionId){
        ApiRequest request = new ApiRequest("Anulacion cesion cheque","cheques","POST","/v1/cheque/cesion/anular",contexto);
        ...
        return  response.crear(AnularCesionEcheqOB.class);
