...
public class Pagos extends ApiObjetos<Pago> {

	/* ========== ATRIBUTOS ========== */
	public static class Pago extends ApiObjeto {
	...
	public static Pago get(Contexto contexto, String numeroTarjeta, String usuarioLP, String codigoEnte, String fechaDesde, String fechaHasta) {
		...
		return response.crear(Pago.class);
	}

	// API-Link_ConsultaPagoPendientes-PagosServicios
	public static Pagos getPendientes(Contexto contexto, String numeroTarjeta) {
		ApiRequest request = new ApiRequest("LinkGetPagosPendientes", "link", "GET", "/v1/servicios/{numeroTarjeta}/pagos/pendientes", contexto);
		request.path("numeroTarjeta", numeroTarjeta);
	...
	public static Pago getStatus(Contexto contexto, String identificadorPago, String timeStampTransaccion) {
		ApiRequest request = new ApiRequest("LinkGetPagosPendientes", "link", "GET", "/v1/servicios/pagos/status", contexto);
	...
	public static void main(String[] args) {
		...
		if (method.equals("get")) {
			Pago datos = get(contexto, "4998590211782905", "0002081", "919", "01082019", "26022020");
			imprimirResultado(contexto, datos);
		}

		if (method.equals("getPendientes")) {
			Pagos datos = getPendientes(contexto, "5046200441045200");
			imprimirResultado(contexto, datos);
		}

		if (method.equals("getStatus")) {
			Pago datos = getStatus(contexto, "", "");
			imprimirResultado(contexto, datos);
		}
