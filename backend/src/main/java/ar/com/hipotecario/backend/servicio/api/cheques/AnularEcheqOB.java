...
public class AnularEcheqOB extends ApiObjetos<AnularEcheqOB.result> {
    ...
    public static AnularEcheqOB post(ContextoOB contexto, String idCheque, String emisorDocumento, String motivoAnulacion){
        ApiRequest request = new ApiRequest("Anulacion cheque","cheques","POST","/v1/cheque/emitido/anular",contexto);
        request.body("cheque_id",idCheque);
        request.body("emisor_documento",emisorDocumento);
        request.body("cheque_motivo_anulacion",motivoAnulacion);
        ...
        return  response.crear(AnularEcheqOB.class);
