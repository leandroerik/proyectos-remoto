...
public class AdmitirEcheqOB extends ApiObjetos<AdmitirEcheqOB.result> {
    ...
    public static AdmitirEcheqOB post(ContextoOB contexto, String idCheque, String beneficiarioDocumento, String beneficiarioDocumentoTipo){
        ApiRequest request = new ApiRequest("Admitir cheque","cheques","POST","/v1/cheque/emitido/admitir",contexto);
        ...
        return  response.crear(AdmitirEcheqOB.class);
    }
}
