...
public class SolicitudCancelacionAnticipada extends ApiObjeto {
	...
	public static SolicitudCancelacionAnticipada get(Contexto contexto, String nroOperacion) {
		...
		return response.crear(SolicitudCancelacionAnticipada.class);
	}
	...
	public static SolicitudCancelacionAnticipadaEstado patch(Contexto contexto, String nroOperacion) {
		ApiRequest request = new ApiRequest("PlazosFijosPatchCancelacionAnticipada", "plazosfijos", "PATCH", "/v1/plazosfijos/{nroOperacion}/cancelacionanticipada/solicitud", contexto);
		request.body("nroOperacion", nroOperacion);
	...
	public static void main(String[] args) {
		...
		if (method.equals("get")) {
			SolicitudCancelacionAnticipada datos = get(contexto, "4998590015391523");
			imprimirResultado(contexto, datos);
		}

		if (method.equals("getEstado")) {
			SolicitudCancelacionAnticipadaEstado datos = getEstado(contexto, "4998590015391523");
			imprimirResultado(contexto, datos);
		}

		if (method.equals("post")) {
			SolicitudCancelacionAnticipadaEstado datos = post(contexto, "4998590015391523");
			imprimirResultado(contexto, datos);
		}

		if (method.equals("patch")) {
			SolicitudCancelacionAnticipadaEstado datos = patch(contexto, "4998590015391523");
			imprimirResultado(contexto, datos);
		}
	}
}
