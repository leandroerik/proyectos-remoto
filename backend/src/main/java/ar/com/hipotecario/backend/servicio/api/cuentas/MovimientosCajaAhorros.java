...
import ar.com.hipotecario.backend.servicio.api.cuentas.MovimientosCajaAhorros.MovimientoCajaAhorro;

public class MovimientosCajaAhorros extends ApiObjetos<MovimientoCajaAhorro> {

	public Integer cantPaginas;
	public Integer numPagina;

	/* ========== ATRIBUTOS ========== */
	public static class MovimientoCajaAhorro extends ApiObjeto {
	...
	public static MovimientosCajaAhorros get(Contexto contexto, String idCuenta, Fecha fechaDesde, Fecha fechaHasta, String numeroPagina, Character orden, Integer pendientes, Character tipoMovimiento, Boolean validactaempleado, String concepto) {
	...
	// API-Cuentas_ConsultaMovimientosCajaAhorro
	static MovimientosCajaAhorros get(Contexto contexto, String idCuenta, Fecha fechaDesde, Fecha fechaHasta, String numeroPagina, Character orden, Integer pendientes, Character tipoMovimiento, Boolean validactaempleado, Character diaHabil, String concepto) {
...
//			request.query("concepto", concepto);
		...
		MovimientosCajaAhorros movimientos = response.crear(MovimientosCajaAhorros.class);
	...
	public static void main(String[] args) {
		...
		Fecha fechaDesde = new Fecha("2021-06-01", "yyyy-MM-dd");
		Fecha fechaHasta = new Fecha("2022-02-01", "yyyy-MM-dd");
		MovimientosCajaAhorros datos = get(contexto, "400400011740843", fechaDesde, fechaHasta, "1", 'A', 0, 'T', false, null);
