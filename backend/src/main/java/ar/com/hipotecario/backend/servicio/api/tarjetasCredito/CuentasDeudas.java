...
public class CuentasDeudas extends ApiObjetos<CuentaDeuda> {
	...
	/* ========== SERVICIOS ========== */
	// API-TarjetasCredito_ConsultaDeudasPagoExpreso
	public static CuentasDeudas get(Contexto contexto, String idEmpresas, Boolean paginar, String secuencial, String tipoConsulta) {
		ApiRequest request = new ApiRequest("PrestamoCuentaDeudas", "tarjetascredito", "GET", "/v1/cuentas/deudas", contexto);
	...
	public static void main(String[] args) {
		...
		CuentasDeudas datos = get(contexto, "4373070", false, "0", "D");
